...
2. **"Unknown column 'duty'"**
   - Run database migration for bills table
   - Add duty column: `ALTER TABLE bills ADD COLUMN duty DECIMAL(10,2) DEFAULT 0.00`
